...
FILE CONTROL.
    ...
    SELECT COMISSION REPORT ASSIGN TO 'COMISSIONREPORT.DAT'.
DATA DIVISION.
FILE SECTION.
FD SALESFILE.
...
01 WS-FIELDS.
   ...
   05 WS-COMMISSION-AMT     PIC 9(08) COMP-3.
   05 WS-TOTAL-COMMISSION   PIC 9(10) COMP-3.
   
01 WS-REGION-SALES.
   05 WS-EAST               PIC 9(07) VALUE ZEROS. 
   05 WS-WEST               PIC 9(07) VALUE ZEROS.
   05 WS-NORTH              PIC 9(07) VALUE ZEROS.
   05 WS-SOUTH              PIC 9(07) VALUE ZEROS.
   
01 HEADING-LINE.
   05 FILLER                PIC X(05) VALUE SPACES.
   05 FILLER                PIC X(16) 'SALESPERSON NAME'.
...
01 COMM-HEADING-LINE1.
   ...
   05 FILLER                PIC X(05) VALUE 'FIRST'.
   05 FILLER                PIC X(11) VALUE SPACES.
   05 FILLER                PIC X(04) VALUE 'LAST'.
...
0130-WRITE-TOTAL-LINE.
    ...
    WRITE PRINT-LINE AFTER ADVANCING A LINE.
